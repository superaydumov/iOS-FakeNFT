...
final class NftCollectionViewCell: UICollectionViewCell {
    ...
    private func setupRatingStars(rating: Int) {
        for item in 0..<5 {
            ...
            starImageView.tintColor = item < rating ? .systemYellow : .yaLightGrayLight
            ...
            NSLayoutConstraint.activate([
                ...
                starImageView.leadingAnchor.constraint(equalTo: ratingView.leadingAnchor, constant: CGFloat(item * 14))
            ])
        }
    }
}

...
final class CatalogViewController: UIViewController, CatalogView {
    ...
    private func setupNavigationBar() {
        ...
        let rightButton = UIBarButtonItem(image: UIImage(named: "buttonSort"), style: .plain, target: self, action: #selector(displayFilterOptions))
...
extension CatalogViewController {
    ...
    func displayAlert(title: String, message: String?, actions: [UIAlertAction]) {
        let viewModel = AlertModel(alertControllerStyle: .alert, alertTitle: title, alertMessage: message, alertActions: actions)
